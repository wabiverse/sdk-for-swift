...
public class Log {
  ...
  /// Operating system code name. View list of [available options](https://github.com/AppwriteServer/AppwriteServer/blob/master/docs/lists/os.json).
  ...
  /// Client code name. View list of [available options](https://github.com/AppwriteServer/AppwriteServer/blob/master/docs/lists/clients.json).
